...
import { TrendingUp, TrendingDown, Calendar, Weight, DollarSign } from "lucide-react"
      ...
      <div className="flex-1 lg:mr-64">
        <main className="container mx-auto px-4 py-8 space-y-6">
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-3xl font-bold text-gold">معاملات طلا</h1>
              <p className="text-cream/60">خرید و فروش طلا با قیمت لحظه‌ای</p>
            </div>
          </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-3xl font-bold text-green-400">{currentPrice.toLocaleString("fa-IR")}</p>
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-3xl font-bold text-red-400">{(currentPrice - 50000).toLocaleString("fa-IR")}</p>
                    <p className="text-xs text-cream/60">ریال</p>
                  </div>
                </div>
              </div>
          ...
          <Card className="bg-navy/50 border-gold/20">
            <CardHeader>
              ...
              <CardDescription className="text-cream/60">خرید یا فروش فوری طلا</CardDescription>
            </CardHeader>
            <CardContent>
                    ...
                    {buyAmount && (
                      <div className="p-4 rounded-lg bg-green-500/10 border border-green-500/30">
                        <div className="flex items-center justify-between">
                          <span className="text-cream/80">مبلغ قابل پرداخت:</span>
                          <span className="text-xl font-bold text-green-400">
                            {(Number.parseFloat(buyAmount) * currentPrice).toLocaleString("fa-IR")} ریال
                          </span>
                        </div>
                      </div>
                    )}
                      ...
                      <div className="p-4 rounded-lg bg-red-500/10 border border-red-500/30">
                        <div className="flex items-center justify-between">
                          ...
                          <span className="text-xl font-bold text-red-400">
                            {(Number.parseFloat(sellAmount) * (currentPrice - 50000)).toLocaleString("fa-IR")} ریال
                          </span>
                        </div>
                      </div>
                    )}
          ...
          <Card className="bg-navy/50 border-gold/20">
            <CardHeader>
              ...
              <CardDescription className="text-cream/60">مشاهده معاملات انجام شده</CardDescription>
            </CardHeader>
            <CardContent>
                  ...
                  >
                    <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-3">
                      <div className="flex items-start gap-3">
                        <div
                          className={`w-10 h-10 rounded-lg flex items-center justify-center flex-shrink-0 ${
                            trade.type === "خرید" ? "bg-green-500/10" : "bg-red-500/10"
                          }`}
                        >
                          {trade.type === "خرید" ? (
                        ...
                        <div className="space-y-1">
                          <div className="flex items-center gap-2">
                            <Badge
                              variant={trade.type === "خرید" ? "default" : "destructive"}
                              className={
                                trade.type === "خرید"
                            ...
                            <Badge
                              variant={trade.status === "تکمیل شده" ? "default" : "secondary"}
                              className={
                          ...
                          <div className="flex items-center gap-4 text-sm text-cream/60">
                            ...
                            <div className="flex items-center gap-1">
                              ...
                              <span>{trade.pricePerGram.toLocaleString("fa-IR")} ریال/گرم</span>
                            </div>
                            <div className="flex items-center gap-1">
                      ...
                      <div className="text-left md:text-right">
                        <p className="text-lg font-bold text-gold">{trade.totalValue.toLocaleString("fa-IR")} ریال</p>
                      </div>
                    </div>
                  </div>
                ))}
